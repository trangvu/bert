...
OUTPUTS=( "tf_nonmasking_wikitext.tfrecord" "tf_nonmasking_wikitext-103.tfrecord" "tf_nonmasking_bookcorpus.tfrecord" )
index=$1
INPUT_FILE="${DATA_DIR}/${INPUTS[$index]}"
OUTPUT_FILE="${OUT_DIR}/${OUTPUTS[$index]}"
VOCAB_FILE="${DATA_DIR}/vocab.txt"

cd $SRC_PATH && python3 create_nonmasking_data.py \
