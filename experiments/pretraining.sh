...
TRAINING_DATA=( "tf_bert_random_wikitext.tfrecord" "tf_bert_random_wikitext-103.tfrecord" "tf_bert_random_bookcorpus.tfrecord" )
...
OUTPUT=$OUT_DIR/$EXP_NAME"-"$CONFIG"-"$DATE
