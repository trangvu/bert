...
sbatch --job-name=ddi-base submit-job-m3h-P100.sh eval_ddi.sh base /scratch/da33/trang/masked-lm/models/bert_base_uncased 2903
sbatch --job-name=ddi-rand submit-job-m3h-P100.sh eval_ddi.sh rand /scratch/da33/trang/masked-lm/models/pubmed/models/pubmed-da-32-random 2903
sbatch --job-name=ddi-pos submit-job-m3h-P100.sh eval_ddi.sh pos /scratch/da33/trang/masked-lm/models/pubmed/models/pubmed-da-32-pos 2903
sbatch --job-name=ddi-entropy submit-job-m3h-P100.sh eval_ddi.sh entropy /scratch/da33/trang/masked-lm/models/pubmed/models/pubmed-da-32-entropy 2903
sbatch --job-name=ddi-adv submit-job-m3h-P100.sh eval_ddi.sh adv /scratch/da33/trang/masked-lm/models/pubmed/models/pubmed-da-32-adv 2903