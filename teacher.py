...
class TeacherModel(object):
  ...
  config = modeling.TeacherConfig(hidden_size=512,
  ...
  def __init__(self,
    ...
    Args:
      ...
      input_states: float32 Tensor of shape [batch_size, seq_length], which are the last hidden states of BERT.
      input_mask: (optional) int32 Tensor of shape [batch_size, seq_length].
      scope: (optional) variable scope. Defaults to "teacher".
